"""
referentiel.py — Les notions et leurs compétences

Partagé par le générateur de questions (fonctions_python) et
l'évaluateur de lacunes (lacune_evaluation), sans que l'un dépende de l'autre.
"""
